 ...
 *
 * @author davebaol */
public class HierarchicalTiledNode extends IndexedTiledNode<HierarchicalTiledNode> {
	/** The index of this tile. */
	public final int index;

	public HierarchicalTiledNode (final int x, final int y, final int type, final int index, final int connectionCapacity) {
