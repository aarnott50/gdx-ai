...
import com.badlogic.gdx.ai.pfa.jumppointsearch.TiledGraph;
 ...
 *
 * @author davebaol */
public interface IndexedTiledGraph<N extends IndexedTiledNode<N>> extends IndexedGraph<N>, TiledGraph<N> {
